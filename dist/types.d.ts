...
export declare type RoutePath = string | RegExp | ((path: string) => RouteParams | boolean | undefined | null);
export declare type OnChangeType = 'change' | 'beforechange';
export declare type OnChangeHandler = (newUrl: URL, oldURL: URL) => void;
...
export declare type MapParamData = (params: RouteParams, url: URL) => PageState | Promise<PageState>;
...
export declare type StateHistory = Map<string, any>;
